...
impl iter::Sum for Vec4 {
    fn sum<I: Iterator<Item = Self>>(iter: I) -> Self {
        iter.fold(Vec4::default(), |a, b| a + b)
    }
}
...
impl Vec4 {
    ...
    pub fn swizzle_0w(&self) -> Vec2 {
        Vec2::new(0f32, self.w())
    }
    ...
    pub fn swizzle_zw(&self) -> Vec2 {
        Vec2::new(self.z(), self.w())
    }

    pub fn swizzle_w0(&self) -> Vec2 {
        Vec2::new(self.w(), 0f32)
    }
    pub fn swizzle_wx(&self) -> Vec2 {
        Vec2::new(self.w(), self.x())
    }
    pub fn swizzle_wy(&self) -> Vec2 {
        Vec2::new(self.w(), self.y())
    }
    pub fn swizzle_wz(&self) -> Vec2 {
        Vec2::new(self.w(), self.z())
    }
    pub fn swizzle_ww(&self) -> Vec2 {
...
impl Vec4 {
    ...
    pub fn swizzle_00z(&self) -> Vec3 {
        Vec3::new(0f32, 0f32, self.z())
    }
    pub fn swizzle_00w(&self) -> Vec3 {
        Vec3::new(0f32, 0f32, self.w())
    }
    ...
    pub fn swizzle_0xz(&self) -> Vec3 {
        Vec3::new(0f32, self.x(), self.z())
    }
    pub fn swizzle_0xw(&self) -> Vec3 {
        Vec3::new(0f32, self.x(), self.w())
    }
    ...
    pub fn swizzle_0yz(&self) -> Vec3 {
        Vec3::new(0f32, self.y(), self.z())
    }
    pub fn swizzle_0yw(&self) -> Vec3 {
        Vec3::new(0f32, self.y(), self.w())
    }
    pub fn swizzle_0z0(&self) -> Vec3 {
        Vec3::new(0f32, self.z(), 0f32)
    }
    pub fn swizzle_0zx(&self) -> Vec3 {
        Vec3::new(0f32, self.z(), self.x())
    }
    pub fn swizzle_0zy(&self) -> Vec3 {
        Vec3::new(0f32, self.z(), self.y())
    }
    pub fn swizzle_0zz(&self) -> Vec3 {
        Vec3::new(0f32, self.z(), self.z())
    }
    pub fn swizzle_0zw(&self) -> Vec3 {
        Vec3::new(0f32, self.z(), self.w())
    }
    pub fn swizzle_0w0(&self) -> Vec3 {
        Vec3::new(0f32, self.w(), 0f32)
    }
    pub fn swizzle_0wx(&self) -> Vec3 {
        Vec3::new(0f32, self.w(), self.x())
    }
    pub fn swizzle_0wy(&self) -> Vec3 {
        Vec3::new(0f32, self.w(), self.y())
    }
    pub fn swizzle_0wz(&self) -> Vec3 {
        Vec3::new(0f32, self.w(), self.z())
    }
    pub fn swizzle_0ww(&self) -> Vec3 {
        Vec3::new(0f32, self.w(), self.w())
    }
    ...
    pub fn swizzle_x0z(&self) -> Vec3 {
        Vec3::new(self.x(), 0f32, self.z())
    }
    pub fn swizzle_x0w(&self) -> Vec3 {
        Vec3::new(self.x(), 0f32, self.w())
    }
    ...
    pub fn swizzle_xxz(&self) -> Vec3 {
        Vec3::new(self.x(), self.x(), self.z())
    }
    pub fn swizzle_xxw(&self) -> Vec3 {
    ...
    pub fn swizzle_xyz(&self) -> Vec3 {
        Vec3::new(self.x(), self.y(), self.z())
    }
    pub fn swizzle_xyw(&self) -> Vec3 {
        Vec3::new(self.x(), self.y(), self.w())
    }
    pub fn swizzle_xz0(&self) -> Vec3 {
        Vec3::new(self.x(), self.z(), 0f32)
    }
    pub fn swizzle_xzx(&self) -> Vec3 {
        Vec3::new(self.x(), self.z(), self.x())
    }
    pub fn swizzle_xzy(&self) -> Vec3 {
        Vec3::new(self.x(), self.z(), self.y())
    }
    pub fn swizzle_xzz(&self) -> Vec3 {
        Vec3::new(self.x(), self.z(), self.z())
    }
    pub fn swizzle_xzw(&self) -> Vec3 {
        Vec3::new(self.x(), self.z(), self.w())
    }
    pub fn swizzle_xw0(&self) -> Vec3 {
        Vec3::new(self.x(), self.w(), 0f32)
    }
    pub fn swizzle_xwx(&self) -> Vec3 {
        Vec3::new(self.x(), self.w(), self.x())
    }
    pub fn swizzle_xwy(&self) -> Vec3 {
        Vec3::new(self.x(), self.w(), self.y())
    }
    pub fn swizzle_xwz(&self) -> Vec3 {
        Vec3::new(self.x(), self.w(), self.z())
    }
    pub fn swizzle_xww(&self) -> Vec3 {
    ...
    pub fn swizzle_y0z(&self) -> Vec3 {
        Vec3::new(self.y(), 0f32, self.z())
    }
    pub fn swizzle_y0w(&self) -> Vec3 {
        Vec3::new(self.y(), 0f32, self.w())
    }
    ...
    pub fn swizzle_yxz(&self) -> Vec3 {
        Vec3::new(self.y(), self.x(), self.z())
    }
    pub fn swizzle_yxw(&self) -> Vec3 {
    ...
    pub fn swizzle_yyz(&self) -> Vec3 {
        Vec3::new(self.y(), self.y(), self.z())
    }
    pub fn swizzle_yyw(&self) -> Vec3 {
        Vec3::new(self.y(), self.y(), self.w())
    }
    pub fn swizzle_yz0(&self) -> Vec3 {
        Vec3::new(self.y(), self.z(), 0f32)
    }
    pub fn swizzle_yzx(&self) -> Vec3 {
        Vec3::new(self.y(), self.z(), self.x())
    }
    pub fn swizzle_yzy(&self) -> Vec3 {
        Vec3::new(self.y(), self.z(), self.y())
    }
    pub fn swizzle_yzz(&self) -> Vec3 {
        Vec3::new(self.y(), self.z(), self.z())
    }
    pub fn swizzle_yzw(&self) -> Vec3 {
        Vec3::new(self.y(), self.z(), self.w())
    }
    pub fn swizzle_yw0(&self) -> Vec3 {
        Vec3::new(self.y(), self.w(), 0f32)
    }
    pub fn swizzle_ywx(&self) -> Vec3 {
        Vec3::new(self.y(), self.w(), self.x())
    }
    pub fn swizzle_ywy(&self) -> Vec3 {
        Vec3::new(self.y(), self.w(), self.y())
    }
    pub fn swizzle_ywz(&self) -> Vec3 {
        Vec3::new(self.y(), self.w(), self.z())
    }
    pub fn swizzle_yww(&self) -> Vec3 {
        Vec3::new(self.y(), self.w(), self.w())
    }

    pub fn swizzle_z00(&self) -> Vec3 {
        Vec3::new(self.z(), 0f32, 0f32)
    }
    pub fn swizzle_z0x(&self) -> Vec3 {
        Vec3::new(self.z(), 0f32, self.x())
    }
    pub fn swizzle_z0y(&self) -> Vec3 {
        Vec3::new(self.z(), 0f32, self.y())
    }
    pub fn swizzle_z0z(&self) -> Vec3 {
        Vec3::new(self.z(), 0f32, self.z())
    }
    pub fn swizzle_z0w(&self) -> Vec3 {
        Vec3::new(self.z(), 0f32, self.w())
    }
    pub fn swizzle_zx0(&self) -> Vec3 {
        Vec3::new(self.z(), self.x(), 0f32)
    }
    pub fn swizzle_zxx(&self) -> Vec3 {
        Vec3::new(self.z(), self.x(), self.x())
    }
    pub fn swizzle_zxy(&self) -> Vec3 {
        Vec3::new(self.z(), self.x(), self.y())
    }
    pub fn swizzle_zxz(&self) -> Vec3 {
        Vec3::new(self.z(), self.x(), self.z())
    }
    pub fn swizzle_zxw(&self) -> Vec3 {
        Vec3::new(self.z(), self.x(), self.w())
    }
    pub fn swizzle_zy0(&self) -> Vec3 {
        Vec3::new(self.z(), self.y(), 0f32)
    }
    pub fn swizzle_zyx(&self) -> Vec3 {
        Vec3::new(self.z(), self.y(), self.x())
    }
    pub fn swizzle_zyy(&self) -> Vec3 {
        Vec3::new(self.z(), self.y(), self.y())
    }
    pub fn swizzle_zyz(&self) -> Vec3 {
        Vec3::new(self.z(), self.y(), self.z())
    }
    pub fn swizzle_zyw(&self) -> Vec3 {
        Vec3::new(self.z(), self.y(), self.w())
    }
    pub fn swizzle_zz0(&self) -> Vec3 {
        Vec3::new(self.z(), self.z(), 0f32)
    }
    pub fn swizzle_zzx(&self) -> Vec3 {
        Vec3::new(self.z(), self.z(), self.x())
    }
    pub fn swizzle_zzy(&self) -> Vec3 {
        Vec3::new(self.z(), self.z(), self.y())
    }
    pub fn swizzle_zzz(&self) -> Vec3 {
        Vec3::new(self.z(), self.z(), self.z())
    }
    pub fn swizzle_zzw(&self) -> Vec3 {
        Vec3::new(self.z(), self.z(), self.w())
    }
    pub fn swizzle_zw0(&self) -> Vec3 {
        Vec3::new(self.z(), self.w(), 0f32)
    }
    pub fn swizzle_zwx(&self) -> Vec3 {
        Vec3::new(self.z(), self.w(), self.x())
    }
    pub fn swizzle_zwy(&self) -> Vec3 {
        Vec3::new(self.z(), self.w(), self.y())
    }
    pub fn swizzle_zwz(&self) -> Vec3 {
        Vec3::new(self.z(), self.w(), self.z())
    }
    pub fn swizzle_zww(&self) -> Vec3 {
        Vec3::new(self.z(), self.w(), self.w())
    }

    pub fn swizzle_w00(&self) -> Vec3 {
        Vec3::new(self.w(), 0f32, 0f32)
    }
    pub fn swizzle_w0x(&self) -> Vec3 {
        Vec3::new(self.w(), 0f32, self.x())
    }
    pub fn swizzle_w0y(&self) -> Vec3 {
        Vec3::new(self.w(), 0f32, self.y())
    }
    pub fn swizzle_w0z(&self) -> Vec3 {
        Vec3::new(self.w(), 0f32, self.z())
    }
    pub fn swizzle_w0w(&self) -> Vec3 {
        Vec3::new(self.w(), 0f32, self.w())
    }
    pub fn swizzle_wx0(&self) -> Vec3 {
        Vec3::new(self.w(), self.x(), 0f32)
    }
    pub fn swizzle_wxx(&self) -> Vec3 {
        Vec3::new(self.w(), self.x(), self.x())
    }
    pub fn swizzle_wxy(&self) -> Vec3 {
        Vec3::new(self.w(), self.x(), self.y())
    }
    pub fn swizzle_wxz(&self) -> Vec3 {
        Vec3::new(self.w(), self.x(), self.z())
    }
    pub fn swizzle_wxw(&self) -> Vec3 {
        Vec3::new(self.w(), self.x(), self.w())
    }
    pub fn swizzle_wy0(&self) -> Vec3 {
        Vec3::new(self.w(), self.y(), 0f32)
    }
    pub fn swizzle_wyx(&self) -> Vec3 {
        Vec3::new(self.w(), self.y(), self.x())
    }
    pub fn swizzle_wyy(&self) -> Vec3 {
        Vec3::new(self.w(), self.y(), self.y())
    }
    pub fn swizzle_wyz(&self) -> Vec3 {
        Vec3::new(self.w(), self.y(), self.z())
    }
    pub fn swizzle_wyw(&self) -> Vec3 {
        Vec3::new(self.w(), self.y(), self.w())
    }
    pub fn swizzle_wz0(&self) -> Vec3 {
        Vec3::new(self.w(), self.z(), 0f32)
    }
    pub fn swizzle_wzx(&self) -> Vec3 {
        Vec3::new(self.w(), self.z(), self.x())
    }
    pub fn swizzle_wzy(&self) -> Vec3 {
        Vec3::new(self.w(), self.z(), self.y())
    }
    pub fn swizzle_wzz(&self) -> Vec3 {
        Vec3::new(self.w(), self.z(), self.z())
    }
    pub fn swizzle_wzw(&self) -> Vec3 {
        Vec3::new(self.w(), self.z(), self.w())
    }
    pub fn swizzle_ww0(&self) -> Vec3 {
        Vec3::new(self.w(), self.w(), 0f32)
    }
    pub fn swizzle_wwx(&self) -> Vec3 {
        Vec3::new(self.w(), self.w(), self.x())
    }
    pub fn swizzle_wwy(&self) -> Vec3 {
        Vec3::new(self.w(), self.w(), self.y())
    }
    pub fn swizzle_wwz(&self) -> Vec3 {
        Vec3::new(self.w(), self.w(), self.z())
    }
    pub fn swizzle_www(&self) -> Vec3 {
